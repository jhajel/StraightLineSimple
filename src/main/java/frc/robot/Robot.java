...
public class Robot extends TimedRobot {
	...
	public void teleopPeriodic() {
		...
		if(!_state){
			...
			_rightMaster.set(ControlMode.Position, 500, DemandType.AuxPID, 0);
			//_rightMaster.set(ControlMode.Position, 50000);
			_leftMaster.follow(_rightMaster, FollowerType.AuxOutput1);
			System.out.println(_rightMaster.getSelectedSensorPosition());
		}
		_firstCall = false;
	}
